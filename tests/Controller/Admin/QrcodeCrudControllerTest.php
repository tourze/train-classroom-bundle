 ...
 * @internal
 */
#[CoversClass(QrcodeCrudController::class)]
#[RunTestsInSeparateProcesses]
final class QrcodeCrudControllerTest extends AbstractEasyAdminControllerTestCase
{
    protected function getControllerService(): QrcodeCrudController
    {
        $controller = self::getContainer()->get(QrcodeCrudController::class);
        self::assertInstanceOf(QrcodeCrudController::class, $controller);
    ...
    {
        $reflection = new \ReflectionClass(QrcodeCrudController::class);
