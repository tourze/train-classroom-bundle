...
use Tourze\TrainClassroomBundle\Controller\Admin\ClassroomCrudController;
use Tourze\TrainClassroomBundle\Entity\Classroom;

/**
 * ClassroomCrudController 配置验证测试
 *
 * @internal
 */
#[CoversClass(ClassroomCrudController::class)]
#[RunTestsInSeparateProcesses]
final class ClassroomCrudControllerTest extends AbstractEasyAdminControllerTestCase
{
    protected function getControllerService(): ClassroomCrudController
    {
        $controller = self::getContainer()->get(ClassroomCrudController::class);
        self::assertInstanceOf(ClassroomCrudController::class, $controller);
    ...
    public function testControllerIsInstantiable(): void
    {
        ...
        $this->assertInstanceOf(ClassroomCrudController::class, $controller);
    }

    public function testGetEntityFqcn(): void
    {
        $this->assertEquals(Classroom::class, ClassroomCrudController::getEntityFqcn());
    }
    ...
    {
        $reflection = new \ReflectionClass(ClassroomCrudController::class);
